export default {
  timetable: {
    ...
    'kawachi': {
      title: '働くを素敵にするチームのつくり方 〜「問題 vs 私たち」でうまくいく〜',
      name: '河内 一弘（かわち かずひろ）',
      affiliation: '株式会社ヌーラボ 管理部 インハウスシステム課 課長',
      image: 'kawachi.png',
      detail: `これまで数多くのプロジェクトやITコミュニティに参加してきましたが、うまくいったときはメンバーが持ち味を発揮しつつ、<br>
              新しい技術や方法論を取り入れたりステークホルダーを巻き込んだりしながら、チームとして問題に向き合えていたように思います。<br>
              今回の発表では、チームで困難を乗り越えながら楽しく働くためにはどうすればよいのか、経験談や失敗談を交えながらお話しできればと思います。<br>
