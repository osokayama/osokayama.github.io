export default {
  timetable: {
    ...
    'seino': {
      ...
      image: 'seino.jpg',
      detail: `主に事業会社を中心にAlexaを使ったビジネスサービスのコンサルティング、構築作業、 Alexaを使用した新規ソリューションのR&D業務に従事する。`,
      twitter: 'https://twitter.com/chao2suke',
      facebook: '',
      github: '',
      external: 'https://dev.classmethod.jp/author/seino-tsuyoshi/',
      profile: `私たちクラスメソッドは非常に「自由な社風」として有名です。その根底にあるのは社員個人がそれぞれ持つプロフェッショナリズムと「とりあえずやってみる」文化です。このセッションではクラスメソッド流の働き方や事例のご紹介を通じて、大人が本気で「やってみる」とどうなるのか、を感じていただきます。`
    },
    'tbd4': {
      title: 'タイトル未定',
      name: '調整中',
