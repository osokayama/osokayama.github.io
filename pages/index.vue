<template>
  <div>
    ...
    <div class="siimple-content siimple-content--medium siimple--mt-5">
      ...
      <p>
        オープンセミナー2025@岡山 実行委員長の末田です。
      </p>
      <p>
        今年のオープンセミナー2025@岡山のメインテーマである「情熱」は、私たち技術者が過去から現在にわたるまで持ち続けてきた、IT ひいてはものづくり全体への情動や熱意を形容するものです。
      </p>
      <p>
        多くの人が集ってトークを繰り広げる OSO の場では、これまで具体的な知見や意見の交換が行われてきました。社会人を中心とする OSO というコミュニティは、参加者ひとりひとりが実りを得られる集まりとしてこれまで何年も続いてきた歴史があります。十余年におよぶ開催実績を眺めると、その時代に応じてその場で話される話題も変化してきました。オープンセミナー2025@岡山の18回目となる今回は視点を心の中へと移し、我々技術者の原点であるパッションを登壇頂く方々十人十色の切り口で分かち合う回にしたいと考えています。
      </p>
      <p>
